...
class BackgroundImageJFrame3 extends JFrame
{
    ...
    JButton b4;
    int win;
    public BackgroundImageJFrame3(int win) {
        ...
        JLabel background=new JLabel(new ImageIcon("C:\\Users\\LIRAROCCA\\Desktop\\eclipse-java-oxygen-1a-win32\\eclipse\\youwin.png"));
