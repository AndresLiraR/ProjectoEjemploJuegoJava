...
Rectangle center2 = new Rectangle((int)((WIDTH/9) *2.5),(int)((HEIGHT/9)*2.5),
...
//huecos
Rectangle ov1 = new Rectangle(70, 125, 45, 45);
Rectangle ov2= new Rectangle(200, 60, 30, 30);
Rectangle ov3= new Rectangle(400, 375, 60, 60);
 int q=0;
...
g.setColor(Color.CYAN);
g.fillRect(center2.x+55,center2.y+25,center2.width+150,center2.height+100);
...
g.drawOval(70, 125, 50, 50);
//ov2
g.fillOval(200, 60, 30, 30);
g.drawOval(200, 60, 30, 30);
//ov3
g.fillOval(400, 375, 60, 60);
g.drawOval(400, 375, 60, 60);
//ov4
g.fillOval(495, 200, 30, 60);
g.drawOval(495, 200, 30, 60);
if(interval<10) {
//ov5
g.fillOval(80, 280, 60, 60);
g.drawOval(80, 280, 60, 60);
}
}
...
if(p1.intersects(ov1)|| p1.intersects(ov2)|| p1.intersects(ov3)){
	 p1.x=WIDTH/9;
	 p1.y=HEIGHT/2;
	}
